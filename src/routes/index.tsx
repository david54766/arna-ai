        ...
        <div className="wrap grid-2">
          <div className="section-copy">
            ...
            <ul className="feature-list">
              <li><span className="fl-title">Wake word — desktop and phone</span><span className="fl-body">Just say <em>hey Arna</em>. She wakes on the machine you're at.<figure style={{ margin: "14px 0 0", display: "grid", gap: 8, justifyItems: "start" }}><img src={heyAsset.url} alt="Arna listening after wake word — v178 on Android" loading="lazy" width={880} height={1907} style={{ width: "min(220px, 60%)", height: "auto", aspectRatio: "880 / 1907", borderRadius: 14, border: "1px solid var(--line)" }} /><figcaption style={{ fontSize: 12, color: "var(--fg-mute)" }}>She hears you across the room.</figcaption></figure></span></li>
